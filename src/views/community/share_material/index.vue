<template>
  <div class="app-container" v-loading="listLoading" element-loading-text="Loading">
    <div class="filter-container" style="margin-bottom:10px;">
      ...
      <router-link :to="'/community/share_material-create'">
      ...
      <el-table-column prop="operate" label="操作" width="160" align="center">
        <template slot-scope="scope">
          ...
          <el-col :span="5">
            ...
            <router-link v-else :to="'/community/share_material-edit/'+scope.row.id">
...
<script>
import { getList,updateData } from '@/api/share_material'
