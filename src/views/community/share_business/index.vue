<template>
  <div class="app-container" v-loading="listLoading" element-loading-text="Loading">
    <div class="filter-container" style="margin-bottom:10px;">
      ...
      <el-select v-model="searchQuery.type" clearable placeholder="类型" style="width:105px;">
      ...
      <router-link :to="'/community/share_business-create'">
    ...
    <el-table ref="multipleTable" :data="list" @selection-change="handleSelectionChange" border fit highlight-current-row>
      ...
      <el-table-column label="缩略图" align="center">
        <template slot-scope="scope">
          <span v-for="img in scope.row.img_list">
            <img :src="img" width="auto" height="80">&nbsp;&nbsp;
          </span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作人" align="center" width="80">
        <template slot-scope="scope">
          <span v-if="scope.row.admin!=null">{{scope.row.admin.name}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="operate" label="操作" width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-col :span="5">
            ...
            <router-link v-else :to="'/community/share_business-edit/'+scope.row.id">
...
<script>
import { getList,updateData } from '@/api/share_business'
    ...
    getList() {
      ...
      getList(this.listQuery).then(response => {
        ...
        for (var i = this.list.length - 1; i >= 0; i--) {
          this.list[i].img_list = JSON.parse(this.list[i].imgs)
        }
