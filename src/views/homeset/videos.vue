<template>
  <div class="app-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" size="small" label-width="130px">
      ...
      <el-form-item label="视频设置" prop="application">
        <div class="list-add"> <el-button type="primary" @click="handleCreate">添加视频</el-button></div>
    ...
    submitForm() {
      this.$refs.postForm.validate(valid => {
        if (valid) {
          ...
          this.$router.push('/homeset/videos')
          this.loading = false
        } else {
